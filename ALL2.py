...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  IRTAZA/MOSHIN"$i"                  "
echo $i""$pu"  WhatsApp  :  92325xxxxx"$i"              "
echo $i""$pu"  FACEBOOK     :  MUJAMMAD MOSHIN"$i"   "
echo $i""$pu"  YOUTUBE   :  YouTube NOT USER"$i"               "
echo $i""$pu"  INSTAGRAM :  @NO "$i"               "
echo $i""$pu"  INSTAGRAM :  @No"$i"          "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Muhammad Mohsin"
echo $ku"YouTube  :"$i" YouTube winner"
